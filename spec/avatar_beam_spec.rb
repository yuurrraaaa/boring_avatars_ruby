...
RSpec.describe BoringAvatarsRuby::AvatarBeam do
  it "should initialize successfully" do
    avatar = BoringAvatarsRuby::AvatarBeam.new({name: "Fred Spec"})
    expect(avatar.svg.nil?).to be_falsey
  end

  it "should handle a nil name parameter" do
    avatar = BoringAvatarsRuby::AvatarBeam.new({name: nil})
    expect(avatar.svg.nil?).to be_falsey
  end

  it "should create an svg avatar with custom colors and size" do
    avatar = BoringAvatarsRuby::AvatarBeam.new({
      name: "Grace Hopper",
