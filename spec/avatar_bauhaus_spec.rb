...
RSpec.describe BoringAvatarsRuby::AvatarBauhaus do
  it "should initialize successfully" do
    avatar = BoringAvatarsRuby::AvatarBauhaus.new({name: "Fred Spec"})
    expect(avatar.svg.nil?).to be_falsey
  end

  it "should handle a nil name parameter" do
    avatar = BoringAvatarsRuby::AvatarBauhaus.new({name: nil})
    expect(avatar.svg.nil?).to be_falsey
  end

  it "should create an svg avatar with custom colors and size" do
    avatar = BoringAvatarsRuby::AvatarBauhaus.new({
      name: "Grace Hopper",
